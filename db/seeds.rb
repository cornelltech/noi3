...
'Philanthropy','Political Campaigns/Election','Political Organization','Public Benefits/Social Security','Public Policy','Public Relations','Public Safety & Emergencies','Racial Justice','Regulatory Affairs','Reproductive Rights','Research','Sanitation','Science & Innovation','Social Services','Space','Sports','Tax & Revenue','Telecommunications','Think Tanks','Trade & Investment','Transportation / Trucking / Railroad','Utilities & Water Resources','Women\'s Rights','Other']
...
# u = User.new(email: 'admin@example.com', password: 'password', username: 'adminuname', password_confirmation: 'password', :admin => true)
# u.skip_confirmation!
# u.save!

u = User.new(email: 'test@example.com', password: 'password', username: 'testusername',
  first_name: "TEST",
  last_name: "USER",
  picture_path: '/assets/users/128.jpg',
  position: Faker::Company.profession,
